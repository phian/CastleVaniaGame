...
#define SIMON_JUMP_MOVING_SPEED 0.1f
//0.1f
...
#define SIMON_STATE_SITDOWN_RIGHT		400
#define SIMON_STATE_SITDOWN_LEFT		500
#define SIMON_STATE_SITDOWN				600
#define SIMON_STATE_USE_WHIP_SIT		700
#define SIMON_STATE_USE_WHIP_STAND		800
